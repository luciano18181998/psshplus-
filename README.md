...
```
apt update -y; apt upgrade -y; apt install wget -y; bash <(wget -qO- https://github.com/luciano18181998/psshplus-/raw/main/gestorssh/instpainel.sh)
```

# ♻ SINCRONIZAR NA VPS SSH!
```
apt install wget -y; bash <(wget -qO- https://github.com/luciano18181998/psshplus-/raw/main/gestorssh/sincpainel.sh)
```

# 🛂 CHECKUSER PARA O APP CONECTA4G!
```
apt install wget -y; bash <(wget -qO- https://github.com/luciano18181998/psshplus-/raw/main/gestorssh/instcheck.sh)
```
